...
namespace Dsw2026Tpi.Data.Migrations
{
    ...
    [Migration("20260728022426_Add_SoftDelete_And_DomainStubs")]
    partial class Add_SoftDelete_And_DomainStubs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dsw2026Tpi.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<Guid?>("AvailabilitySlotsId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AvailabilitySlotsId");
            ...
            modelBuilder.Entity("Dsw2026Tpi.Domain.Entities.AvailabilitySlots", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dsw2026Tpi.Domain.Entities.Appointment", b =>
                {
                    b.HasOne("Dsw2026Tpi.Domain.Entities.AvailabilitySlots", "AvailabilitySlots")
                        .WithMany()
                        .HasForeignKey("AvailabilitySlotsId");
